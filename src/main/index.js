...
// ipcMain.handle('update-department', (_, department) => DepartmentsAPI.updateDepartment(department))
// ipcMain.handle('delete-department', (_, id) => DepartmentsAPI.deleteDepartment(id))

// ipcMain.handle('create-ticket', (_, ticket) => DepartmentsAPI.createDepartment(ticket))
// ipcMain.handle('read-ticket', () => TicketsAPI.readTickets())
// ipcMain.handle('update-ticket', (_, ticket) => DepartmentsAPI.updateDepartment(ticket))
// ipcMain.handle('delete-ticket', (_, id) => DepartmentsAPI.deleteDepartment(id))
